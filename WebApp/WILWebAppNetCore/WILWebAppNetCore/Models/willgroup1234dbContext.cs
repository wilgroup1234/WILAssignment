...
{
    public partial class willgroup1234dbContext : DbContext
    {
        public willgroup1234dbContext()
        {
        }

        public willgroup1234dbContext(DbContextOptions<willgroup1234dbContext> options)
            : base(options)
        {
        }
